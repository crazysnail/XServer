...
#define JSON_ASSERT_UNREACHABLE ZXERO_ASSERT( false )
#define JSON_ASSERT( condition ) if (!( condition )) JSON_FAIL_MESSAGE( #condition )// @todo <= change this into an exception throw //throw condition
